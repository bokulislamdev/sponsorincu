...
<div class="page-breadcrumb d-none d-sm-flex align-items-center py-2 px-3" style="background: rgb(46 57 78);">
    <div class="pe-3"><h5 class="text-white m-0">Product Edit ({{$product->type}})</h5></div>
    <div class="ms-auto">
        ...
        <form action="{{route('admin.product.update',$product->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
               ...
               <div class="col-12 col-md-6 py-2">
                ...
                <small class="form-text text-danger">{{ $errors->first('vendor_id') }}</small>
            </div>
                <div class="col-12 col-md-6 py-2">
                    <label for="" class="form-label">{{$product->type == 'service' ? 'Service' : 'Product'}} Name <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="name" value="{{$product->name}}">
                    <span class="text-danger">{{$errors->first('name')}}</span>
                </div>

                <div class="col-12 col-md-6 py-2">
                    <label for="" class="form-label">{{$product->type == 'service' ? 'Service' : 'Product'}} Arabic Name</label>
                ...
                <div class="col-12 col-md-6 py-2">
                    <label for="" class="form-label">{{$product->type == 'service' ? 'Service' : 'Product'}} Price <span class="text-danger">*</span></label>
                ...
                <div class="col-12 col-md-6 py-2">
                    ...
                    <select name="active_price" class="form-control">
                            <option value="1" {{$product->active_price == 1 ? 'selected' : ''}}>Regular Price</option>
                            <option value="2" {{$product->active_price == 2 ? 'selected' : ''}}>Discount Price</option>
                    </select>
                ...
                <div class="col-12 col-md-6 py-2">
                    <label for="" class="form-label">{{$product->type == 'service' ? 'Service' : 'Product'}} Image <span class="text-danger">*</span></label>
                ...
                <div class="col-12 col-md-6 py-2">
                    <label for="" class="form-label">{{$product->type == 'service' ? 'Service' : 'Product'}} Multiple Image</label>
                ...
                <div class="for_feed">
                    ...
                    <div class="col-12 col-md-6 py-2">
                        ...
                        <input type="text" class="form-control" name="package_size" placeholder="25 KG" value="{{$product->package_size}}" >
                    ...
                    <div class="col-12 col-md-6 py-2">
                        ...
                        <input type="text" class="form-control" name="package_type" placeholder="drum"  value="{{$product->package_type}}">
                    ...
                    <div class="col-12 col-md-6 py-2">
                        ...
                        <input type="text" class="form-control" name="country_of_origin" placeholder="Made in Saudi" value="{{$product->country_of_origin}}">
                        <span class="text-danger">{{$errors->first('country_of_origin')}}</span>
                    </div>
                    <div class="col-12 col-md-6 py-2">
                        <label> Color</label>
                        <input type="text" class="form-control" name="color" value="{{old('name_ar')}}" value="{{$product->color}}">
                        <small class="form-text text-danger">{{ $errors->first('color') }}</small>
                    </div>
                    <div class="col-12 col-md-6 py-2">
                        <label for="" class="form-label">Cas Number</label>
                        <input type="text" class="form-control" name="cas" placeholder="8067-69-4" value="{{$product->cas}}">
                ...
                <div class="col-12 col-md-6 py-2">
                    ...
                    <input type="text" class="form-control" name="brand" placeholder="ACI" value="{{$product->brand}}">
                    <span class="text-danger">{{$errors->first('Package_type')}}</span>
                </div>
                @endif
