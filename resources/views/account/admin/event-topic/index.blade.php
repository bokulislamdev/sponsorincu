@extends('account.layouts.app',['title' => 'Event Topic All'])
...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center py-2 px-3" style="background: rgb(46 57 78);">
        <div class="pe-3"><h5 class="text-white m-0">Event Topics</h5></div>
        <div class="ms-auto">
            <a href="{{route('admin.event-topic.create')}}" class="btn btn-primary custom-head-link"> <i class="lni lni-circle-plus custom-head-link"></i>Create Event Topic</a>
        </div>
    </div>
    <!--end breadcrumb-->
